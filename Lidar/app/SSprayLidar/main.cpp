...
/*
	...
	printf("motor info --> %d %d %d", motorInfo.desired_speed, motorInfo.max_speed, motorInfo.min_speed);
...
//aggiunto -->
	...
	drv->startScanExpress(0, scanModes[1].id, 0, nullptr);


	drv->setMotorSpeed(200);
